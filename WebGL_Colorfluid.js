...
<script src="https://cdn.jsdelivr.net/gh/Milch-Schnitte/webflowFunctions@main/WebGL_colorfluid.js"></script>
<script>
  var canvas = document.createElement("canvas");
  canvas.id = "colorfluid_canvas";
  canvas.width = 1280;
  canvas.height = 648;
  var container = document.getElementById("colorfluid");
  ...
  initcolorfluid(container);
</script>
*/
function initcolorfluid() {
